...
(Name:'Система отопления';Frm:SSSS;Ed:'';TipSens:TipIzm;Min:0;Max:5;Def:0;
...
(Name:'Воздушный обогреватель';Frm:SSSS;Ed:'';TipSens:TipIzm;Min:0;Max:1;
...
(Name:'Фрамуги Север';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:16;Mech:DZM_SVENTILATION;AccessR:R_CONFIG;AccessW:RW_SUPERVISOR),
(Name:'Фрамуги Юг';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:17;Mech:DZM_SVENTILATION;AccessR:R_CONFIG;AccessW:RW_SUPERVISOR),
...
(Name:'Резерв 1';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:30;Mech:DZM_SREZ2;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Резерв 2';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:31;Mech:DZM_SREZ2;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Резерв 3';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:32;Mech:DZM_SREZ2;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Резерв 4';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:33;Mech:DZM_SREZ2;AccessR:R_CONFIG;AccessW:W_CONFIG),
...
(Name:'Вентиляторы';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:40;Mech:DZM_SFAN;AccessR:R_CONFIG;AccessW:RW_SUPERVISOR),
(Name:'Нагреватель';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:41;Mech:DZM_AIR_HEATS;AccessR:R_CONFIG;AccessW:RW_SUPERVISOR),
...
(Name:'Регулятор 1';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:47;Mech:DZM_SHEATING;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Регулятор 2';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:48;Mech:DZM_SHEATING;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Регулятор 3';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:49;Mech:DZM_SHEATING;AccessR:R_CONFIG;AccessW:W_CONFIG),
// 51
(Name:'Регулятор 4';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:50;Mech:DZM_SHEATING;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Регулятор 5';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:51;Mech:DZM_SHEATING;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Резерв 1';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:52;Mech:DZM_SREZ2;AccessR:RW_INVISIBLE;AccessW:W_CONFIG),
(Name:'Резерв 2';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:53;Mech:DZM_SREZ2;AccessR:RW_INVISIBLE;AccessW:W_CONFIG),
(Name:'Резерв 3';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:54;Mech:DZM_SREZ2;AccessR:RW_INVISIBLE;AccessW:W_CONFIG),
(Name:'Резерв 4';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
    Index:55;Mech:DZM_SREZ2;AccessR:RW_INVISIBLE;AccessW:W_CONFIG),
...
(Name:'Осадки';Frm:CpMpN;Ed:'-вход';TipSens:TipIzm;Min:0;Max:0;
    Index:60;Mech:0;AccessR:RW_INVISIBLE;AccessW:RW_NOEDIT),
...
(Name:'Температура воздуха 1';Frm:CpMpN;Ed:'-вход';TipSens:TipIzm;Min:0;Max:0;
    Index:63;Mech:0;AccessR:R_CONFIG;AccessW:RW_SUPERVISOR),
...
(Name:'Влажность воздуха 1';Frm:CpMpN;Ed:'-вход';TipSens:TipIzm;Min:0;Max:0;
    Index:67;Mech:0;AccessR:R_CONFIG;AccessW:RW_SUPERVISOR),
...
// 101
//(Name:'Воздушный обогреватель 1';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
//    Index:-91;Mech:DZM_SHEATING;AccessR:R_CONFIG;AccessW:W_CONFIG),
//(Name:'Воздушный обогреватель 2';Frm:CpMpN;Ed:'-реле';TipSens:TipIzm;Min:0;Max:0;
//    Index:-92;Mech:DZM_SHEATING;AccessR:R_CONFIG;AccessW:W_CONFIG)
);
...
************************************************************}
//------------------Блок конфигурация оборудования-----------------
...
var  DZ_NameTimer:array [1..DZ_SumTimer] of TNameConst=(
 ...
 (Name:'Держать температуру воздуха (если 0-прогр не активна)';Frm:SSpS0;Ed:'°C';TipSens:TipCalc;Min:0;Max:30;Def:HIDE_MIN_MAX;
    Index:DZ_iTaskTemper;GridColor:clRed;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_GUEST),
...
const        DZ_SumParUpr=           24;
             ...
             DZ_SizeParUpr=          86;   // Размер блока параметров его нельзя менять! Только если меняем размеры блоков!
...
(Name:'Держать Т отпления по датчику';Frm:CalcT;Ed:'';TipSens:TipCalc;Min:1;Max:255;Def:0;Index:DZ_iScr+10;GridColor:$ffdf00;Mech:0;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Держать Т вентил по датчику';Frm:CalcT;Ed:'';TipSens:TipCalc;Min:1;Max:255;Def:0;Index:DZ_iScr+11;GridColor:$ffdf00;Mech:DZM_SHEATING;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR)
);
...
const        DZ_SumParTune=          128;
             ...
             //DZ_iHeatMinTimeOn=      DZ_iMinKontRH+6*2;     // NEW
             //DZ_iHeatMaxTimeOn=      DZ_iMinKontRH+7*2;     // NEW

             DZ_iHeatOnIf=           DZ_iMinKontRH+6*2;     // NEW
             DZ_iHeatOffIf=          DZ_iMinKontRH+7*2;     // NEW
...
var DZ_NameTuneClimate:array [1..DZ_SumParTune] of TNameConst=(
         //(Name:'Источник для темпер отопления';Frm:CalcT;Ed:'';TipSens:TipCalc;Min:1;Max:0;Def:HIDE_MIN_MAX;Index:DZ_iParAirToWater;Mech:0;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
         //(Name:'Источник для темпер вентиляции';Frm:CalcT;Ed:'';TipSens:TipCalc;Min:1;Max:0;Def:HIDE_MIN_MAX;Index:DZ_iParAirToWater;Mech:0;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
         //(Name:'Включать если температура меньше чем';Frm:SSSS;Ed:'';TipSens:TipCalc;Min:1;Max:50;Def:HIDE_MIN_MAX;Index:DZ_iHeatOnIf;Mech:DZM_AIR_HEATING;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
         //(Name:'Выключать если температура больше чем';Frm:SSSS;Ed:'';TipSens:TipCalc;Min:1;Max:50;Def:HIDE_MIN_MAX;Index:DZ_iHeatOffIf;Mech:DZM_AIR_HEATING;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
         //(Name:'Минимальное время работы, мин';Frm:SSSS;Ed:'';TipSens:TipCalc;Min:1;Max:999;Def:HIDE_MIN_MAX;Index:DZ_iHeatMinTimeOn;Mech:DZM_AIR_HEATING;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
         //(Name:'Максимальное время работы, мин';Frm:SSSS;Ed:'';TipSens:TipCalc;Min:1;Max:999;Def:HIDE_MIN_MAX;Index:DZ_iHeatMaxTimeOn;Mech:DZM_AIR_HEATING;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
         //(Name:'Минимальная пауза между включениями';Frm:SSSS;Ed:'';TipSens:TipCalc;Min:1;Max:999;Def:HIDE_MIN_MAX;Index:DZ_iHeatMinPause;Mech:DZM_AIR_HEATING;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
         ...
         (Name:'Фрамуги - допустимое отклонение от датчика';Frm:SS;Ed:'';TipSens:TipCalc;Min:0;Max:20;Def:10;Index:DZ_iPAirToWater+4;Mech:DZM_FRAM_SOUTH;AccessR:RW_SUPERVISOR;AccessW:RW_USER),
         ...
         (Name:'СО2 - Задержка до открытия клапана';Frm:SSSS;Ed:'мин';TipSens:TipCalc;Min:0;Max:20;Def:5;            Index:DZ_iSunToClim+12;Mech:DZM_CO2;AccessR:RW_SUPERVISOR;AccessW:RW_USER),
         (Name:'Экран термический - Твнеш разворачивает при';Frm:SSpS0;Ed:'°C';TipSens:TipCalc;Min:-10;Max:20;Def:6;            Index:DZ_iScreen+4;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран термический - Солнце сворачивает при';Frm:SSSS;Ed:'Вт/м2';TipSens:TipCalc;Min:0;Max:200;Def:5;            Index:DZ_iScreen+2;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран затеняющий - Твнеш разворачивает при';Frm:SSpS0;Ed:'°C';TipSens:TipCalc;Min:-20;Max:12;Def:-10;            Index:DZ_iScreen+8;Mech:DZM_SCREEN_HG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран затеняющий - Солнце разворачивает при';Frm:SSSS;Ed:'Вт/м2';TipSens:TipCalc;Min:0;Max:1200;Def:750;            Index:DZ_iScreen;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         ...
         (Name:'Экран вертикальный - Твнеш разворачивает при';Frm:SSpS0;Ed:'°C';TipSens:TipCalc;Min:-20;Max:12;Def:10;           Index:DZ_iScreen+6;Mech:DZM_SCREEN_TV1;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран вертикальный - Солнце сворачивает, кроме наветренной';Frm:SSSS;Ed:'Вт/м2';TipSens:TipCalc;Min:0;Max:600;Def:200;            Index:DZ_iScreen+14;Mech:DZM_SCREEN_TV1;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран вертикальный - Солнце сворачивает все при';Frm:SSSS;Ed:'Вт/м2';TipSens:TipCalc;Min:0;Max:1200;Def:600;            Index:DZ_iScreen+12;Mech:DZM_SCREEN_TV1;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран вертикальный - ветер начинает влиять при';Frm:SSpS0;Ed:'м/сек';TipSens:TipCalc;Min:1;Max:15;Def:1.5;            Index:DZ_iScreen+10;Mech:DZM_SCREEN_TV1;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран - Разворачивание этап 1 начать с';Frm:SSSS;Ed:'%';TipSens:TipCalc;Min:30;Max:100;Def:50;             Index:DZ_iScreen+26;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран - Разворачивание этап 1 размер шага';Frm:SSSS;Ed:'%';TipSens:TipCalc;Min:0;Max:10;Def:4;             Index:DZ_iScreen+28;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран - Разворачивание этап 1 пауза между шагами';Frm:SSSS;Ed:'мин';TipSens:TipCalc;Min:0;Max:20;Def:2;             Index:DZ_iScreen+30;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран - Разворачивание этап 2 начать с';Frm:SSSS;Ed:'%';TipSens:TipCalc;Min:50;Max:100;Def:80;            Index:DZ_iScreen+32;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         // 95
         (Name:'Экран - Разворачивание этап 2 размер шага';Frm:SSSS;Ed:'%';TipSens:TipCalc;Min:0;Max:10;Def:2;             Index:DZ_iScreen+34;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран - Разворачивание этап 2 пауза между шагами';Frm:SSSS;Ed:'мин';TipSens:TipCalc;Min:0;Max:20;Def:1;             Index:DZ_iScreen+36;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран исполнять если шаг больше';Frm:SSSS;Ed:'%';TipSens:TipCalc;Min:0;Max:20;Def:2;              Index:DZ_iScreen+38;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Экран полное сворачивание/разворачивание не чаще';Frm:SSSS;Ed:'мин';TipSens:TipCalc;Min:20;Max:360;Def:60;             Index:DZ_iScreenGlass+6;Mech:DZM_SCREEN_TG;AccessR:RW_GUESTI;AccessW:RW_USER),
         ...
         (Name:'Воздушный обогрев - включать,если температура меньше чем заданная на';Frm:SSpS0;Ed:'°C';TipSens:TipCalc;Min:0;Max:50;Def:0;Index:DZ_iHeatOnIf;Mech:DZM_AIR_HEATS;AccessR:RW_GUESTI;AccessW:RW_USER),
         (Name:'Воздушный обогрев - выключать,если температура больше чем заданная на';Frm:SSpS0;Ed:'°C';TipSens:TipCalc;Min:0;Max:50;Def:0;Index:DZ_iHeatOffIf;Mech:DZM_AIR_HEATS;AccessR:RW_GUESTI;AccessW:RW_USER),
         // 125
...
DZ_Diagnos:array [1..DZ_SUM_DIAGNOS] of TDiagnos = (
   (Name:'Нет задания температуры воздуха';ShowPozition:29;LevelAlarm:alFatal;
      PosInHot:51;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoTask'),
   (Name:'Нет измерения температуры воздуха';ShowPozition:25;LevelAlarm:alFatal;
      PosInHot:27;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoMesAir'),
   (Name:'Нет измерения температуры воды в контуре 1';ShowPozition:21;LevelAlarm:alFatal;
      PosInHot:77;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoMesWater1';Mech:DZM_VALVE1),
   (Name:'Нет измерения температуры воды в контуре 2';ShowPozition:15;LevelAlarm:alFatal;
      PosInHot:85;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoMesWater2';Mech:DZM_VALVE2),
   (Name:'Нет измерения температуры воды в контуре 3';ShowPozition:11;LevelAlarm:alFatal;
      PosInHot:93;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoMesWater3';Mech:DZM_VALVE3),
   (Name:'Нет измерения температуры воды в контуре 4';ShowPozition:8;LevelAlarm:alFatal;
      PosInHot:101;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoMesWater4';Mech:DZM_VALVE4),
   //(Name:'Нет измерения температуры воды в контуре 5';ShowPozition:5;LevelAlarm:alFatal;
   //   PosInHot:109;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoMesWater5';Mech:DZM_VALVE5),

   (Name:'Клапан контура 1 в ручном режиме';ShowPozition:19;LevelAlarm:alHand;
      PosInHot:145;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_VALVE1;),
   (Name:'Насос контура 1 в ручном режиме';ShowPozition:16;LevelAlarm:alHand;
      PosInHot:147;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_PUMP1;),
   (Name:'Клапан контура 2 в ручном режиме';ShowPozition:13;LevelAlarm:alHand;
      PosInHot:149;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_VALVE2;),
   // 11
   (Name:'Насос контура 2 в ручном режиме';ShowPozition:10;LevelAlarm:alHand;
      PosInHot:151;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_PUMP2;),
   (Name:'Клапан контура 3 в ручном режиме';ShowPozition:7;LevelAlarm:alHand;
      PosInHot:153;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_VALVE3;),
   (Name:'Насос контура 3 в ручном режиме';ShowPozition:4;LevelAlarm:alHand;
      PosInHot:155;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_PUMP3;),
   (Name:'Клапан контура 4 в ручном режиме';ShowPozition:2;LevelAlarm:alHand;
      PosInHot:157;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_VALVE4;),
   (Name:'Насос контура 4 в ручном режиме';ShowPozition:-2;LevelAlarm:alHand;
      PosInHot:159;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_PUMP4;),
   //(Name:'Клапан контура 5 в ручном режиме';ShowPozition:-5;LevelAlarm:alHand;
   //   PosInHot:161;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_VALVE5;),
   //(Name:'Насос контура 5 в ручном режиме';ShowPozition:-8;LevelAlarm:alHand;
   //   PosInHot:163;Oper:BGT;OperValue:0;Color:clRed;Voice:'HandControl';Mech:DZM_PUMP5;),

   (Name:'Т воды в 1-м контуре не регулируется';ShowPozition:-1;LevelAlarm:alAttention;
      PosInHot:76;Oper:BGT;OperValue:90;Color:clRed;Voice:'NoRegul1';Mech:DZM_VALVE1),
   (Name:'Т воды в 2-м контуре не регулируется';ShowPozition:-4;LevelAlarm:alAttention;
      PosInHot:84;Oper:BGT;OperValue:90;Color:clRed;Voice:'NoRegul2';Mech:DZM_VALVE2),
   (Name:'Т воды в 3-м контуре не регулируется';ShowPozition:-7;LevelAlarm:alAttention;
      PosInHot:92;Oper:BGT;OperValue:90;Color:clRed;Voice:'NoRegul3';Mech:DZM_VALVE3),
   // 21
   (Name:'Т воды в 4-м контуре не регулируется';ShowPozition:-10;LevelAlarm:alAttention;
      PosInHot:100;Oper:BGT;OperValue:90;Color:clRed;Voice:'NoRegul4';Mech:DZM_VALVE4),
   //(Name:'Т воды в 5-м контуре не регулируется';ShowPozition:-13;LevelAlarm:alAttention;
   //   PosInHot:108;Oper:BGT;OperValue:90;Color:clRed;Voice:'NoRegul5';Mech:DZM_VALVE5),

   (Name:'Клапан 1 контура полностью закрыт';ShowPozition:0;LevelAlarm:alBlueAttention;
      PosInHot:146;Oper:BLE;OperValue:3;Color:clKontur0;Mech:DZM_VALVE1),
   (Name:'Клапан 1 контура полностью открыт';ShowPozition:-22;LevelAlarm:alBlueAttention;
      PosInHot:146;Oper:BGT;OperValue:97;Color:clKontur100;Mech:DZM_VALVE1),
   (Name:'Клапан 2 контура полностью закрыт';ShowPozition:0;LevelAlarm:alBlueAttention;
      PosInHot:150;Oper:BLE;OperValue:3;Color:clKontur0;Mech:DZM_VALVE2),
   (Name:'Клапан 2 контура полностью открыт';ShowPozition:-26;LevelAlarm:alBlueAttention;
      PosInHot:150;Oper:BGT;OperValue:97;Color:clKontur100;Mech:DZM_VALVE2),
   (Name:'Клапан 3 контура полностью закрыт';ShowPozition:0;LevelAlarm:alBlueAttention;
      PosInHot:154;Oper:BLE;OperValue:3;Color:clKontur0;Mech:DZM_VALVE3),
   (Name:'Клапан 3 контура полностью открыт';ShowPozition:-30;LevelAlarm:alBlueAttention;
      PosInHot:154;Oper:BGT;OperValue:97;Color:clKontur100;Mech:DZM_VALVE3),
   (Name:'Клапан 4 контура полностью открыт';ShowPozition:-34;LevelAlarm:alBlueAttention;
      PosInHot:158;Oper:BGT;OperValue:97;Color:clKontur100;Mech:DZM_VALVE4)
   //(Name:'Клапан 5 контура полностью открыт';ShowPozition:-38;LevelAlarm:alBlueAttention;
   //  PosInHot:162;Oper:BGT;OperValue:97;Color:clKontur100;Mech:DZM_VALVE4)
//   (Name:'Нет измерения влажности воздуха';ShowPozition:-27;LevelAlarm:alFatal;
//      PosInHot:25;Oper:BLE;OperValue:0;Color:clRed;Voice:'NoMesAir')
);
...
//              DZ_sizeTepl=        DZ_iMechanic+sizeTMech+10*2;
              ...
              iSensPipe1      =-11;
//              MechPower       =-30;
const DZ_cDefineHot:array [1..DZ_SumMesHot] of TNameConst=( //TDZDefineHot=(
// ----------------- Метеоданные -----------------
//1
...
//21
(Name:'Температура воздуха 1 (Т1)';Frm:SSpS0;Ed:'°C';TipSens:{TipGoTask}SensorRCS;Min:-1;Max:70;Def:FATAL_MIN_MAX;
    Index:DZ_itTAir;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Температура воздуха 2 (Т2)';Frm:SSpS0;Ed:'°C';TipSens:SensorRCS;Min:0;Max:70;Def:HIDE_MIN_MAX;
    Index:DZ_itTAir+3;Mech:DZM_SENS_TEMP2;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Температура воздуха 3 (Т3)';Frm:SSpS0;Ed:'°C';TipSens:SensorRCS;Min:-1;Max:70;Def:FATAL_MIN_MAX;
    Index:DZ_itTAir+6;Mech:DZM_SENS_TEMP3;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Температура воздуха 4 (Т4)';Frm:SSpS0;Ed:'°C';TipSens:SensorRCS;Min:0;Max:70;Def:HIDE_MIN_MAX;
...
(Name:'Температура для отопления';Frm:SSpS0;Ed:'°C';TipSens:TipGoTask;Min:0;Max:70;Def:HIDE_MIN_MAX;
    Index:DZ_iZoneStatus+10;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Источник для темпер отопления';Frm:CalcT;Ed:'';TipSens:TipGoTask;Min:1;Max:255;Def:HIDE_MIN_MAX;
    Index:DZ_iZoneStatus+8;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Температура для вентиляции';Frm:SSpS0;Ed:'°C';TipSens:TipGoTask;Min:0;Max:70;Def:HIDE_MIN_MAX;
    Index:DZ_iZoneStatus+12;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Источник для темпер вентиляции';Frm:CalcT;Ed:'';TipSens:TipGoTask;Min:1;Max:255;Def:HIDE_MIN_MAX;
    Index:DZ_iZoneStatus+9;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
// 31
(Name:'Воздушный обогреватель Состояние';Frm:ComboBit;Ed:'0';TipSens:TipBit;Min:comOnOff;Max:comOnOff+1;Def:HIDE_MIN_MAX;
    Index:DZ_iZoneStatus+14;Mech:DZM_AIR_HEATS;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Воздушный обогреватель Время работы';Frm:SSpS0;Ed:'мин';TipSens:TipTime;Min:0;Max:999;Def:HIDE_MIN_MAX;
    Index:DZ_iZoneStatus+16;Mech:DZM_AIR_HEATS;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
