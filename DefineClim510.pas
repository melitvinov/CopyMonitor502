...
(Name:'Температура воздуха 1 - Напряжение 2';Frm:SSSS;Ed:'мВ';TipSens:TipIzm;Min:0;Max:6000;
    Index:8;Mech:DZM511_SENS_TEMP1;AccessR:R_CONFIG;AccessW:W_CONFIG),
(Name:'Температура воздуха 1 - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура воздуха 2 - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура воздуха 3 - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура воздуха 4 - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура воздуха 5 - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура воздуха 6 - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура охлаждения - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура шатра - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура почвы - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура стекла - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура входа AHU - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
(Name:'Температура выхода AHU - Эталон 2';Frm:SSpS0;Ed:'°C';TipSens:TipIzm;Min:1;Max:100;
...
//         (Name:'Контур подлотковый - Оптимальная температура';Frm:SSSpS;Ed:'°C';TipSens:TipCalc;Min:0;Max:90;Def:0;Index:DZ_iOptTPipe+4;Mech:DZM_VALVE5;AccessR:RW_GUESTI;AccessW:RW_USER),
         ...
         (Name:'Исполнитель дозации СО2';Frm:SSSS;Ed:'';TipSens:TipIzm;Min:0;Max:10;Def:HIDE_MIN_MAX;Index:DZ511_iScr+4;Mech:DZM511_CO2;AccessR:RW_GUEST;AccessW:RW_GUEST),
...
const        DZ511_SumParTune=          132;//129
             DZ511_iSunToClim=          0;
...
//         (Name:'Экран - Твнеш увеличивает открытие в';Frm:SSpSSS;Ed:'раз';TipSens:TipCalc;Min:0;Max:10;Def:5;Index:DZ511_iScreen+24;Mech:DZM511_SCREEN_TG;AccessR:RW_USERI;AccessW:RW_USER),
         ...
         (Name:'Скорость AHU - минимальная температура';Frm:SS;Ed:'°C';TipSens:TipCalc;Min:0;Max:100;Def:0;Index:DZ511_EndTune-11;Mech:DZM511_SPEED_AHU1;AccessR:RW_SUPERVISOR;AccessW:RW_SUPERVISOR),
         (Name:'Скорость AHU - максимальная температура';Frm:SS;Ed:'°C';TipSens:TipCalc;Min:0;Max:100;Def:0;Index:DZ511_EndTune-10;Mech:DZM511_SPEED_AHU1;AccessR:RW_SUPERVISOR;AccessW:RW_SUPERVISOR),
         (Name:'Цель изменить теплоноситель на. Ограничение';Frm:SS;Ed:'';TipSens:TipCalc;Min:0;Max:100;Def:10;Index:DZ511_EndTune-9;Mech:DZM_VALVE1;AccessR:RW_SUPERVISOR;AccessW:RW_SUPERVISOR)
...
const
             ...
             DZ511_SumCO2  =        67;
             DZ511_CO2task =        62;
             DZ511_SumLight50 =     142;
             DZ511_SumLight100 =    143;
...
(Name:'Датчик СО2 в рукаве';Frm:SSSpS;Ed:'ppm/10';TipSens:SensorRCS;Min:0;Max:3000;Def:HIDE_MIN_MAX;
    Index:DZ511_itRH+9;Mech:DZM511_SENS_CO_2;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
                                                                                    //               цель изменить теплоноситель
// 31
(Name:'Температура для отопления';Frm:SSpS0;Ed:'°C';TipSens:TipGoTask;Min:0;Max:70;Def:HIDE_MIN_MAX;
    Index:DZ511_iZoneStatus+10;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Источник для темпер отопления';Frm:CalcT;Ed:'';TipSens:TipGoTask;Min:1;Max:255;Def:HIDE_MIN_MAX;
    Index:DZ511_iZoneStatus+8;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Температура для вентиляции';Frm:SSpS0;Ed:'°C';TipSens:TipGoTask;Min:0;Max:70;Def:HIDE_MIN_MAX;
    Index:DZ511_iZoneStatus+12;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'Источник для темпер вентиляции';Frm:CalcT;Ed:'';TipSens:TipGoTask;Min:1;Max:255;Def:HIDE_MIN_MAX;
    Index:DZ511_iZoneStatus+9;Mech:DZM_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
//35
(Name:'Внутренняя освещенность';Frm:SSSS;Ed:'Вт/м2';TipSens:SensorRCS;Min:0;Max:1400;Def:HIDE_MIN_MAX;
...
(Name:'Текущая система по стратегии';Frm:SSSpS;Ed:'';TipSens:TipCalc;Min:0;Max:1000;Def:HIDE_MIN_MAX;        // текущая стратегия
    Index:DZ511_iZoneStatus+18;Mech:DZM511_SENS_TEMP1;AccessR:RW_GUEST;AccessW:RW_GUEST),
//55
(Name:'Состояние досветки';Frm:ComboBit;Ed:'0';TipSens:TipBit;Min:comOnOff;Max:comOnOff+1;Def:HIDE_MIN_MAX;
...
(Name:'СО2 - Задано по программе';Frm:SSSpS;Ed:'ppm/10';TipSens:TipTimer;Min:0;Max:1500;Def:HIDE_MIN_MAX;
    Index:DZ511_itTaskT+14;Mech:DZM511_CO2;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
(Name:'СО2 - ДЕРЖАТЬ концентрацию';Frm:SSSpS;Ed:'ppm/10';TipSens:TipSun;Min:0;Max:1500;Def:HIDE_MIN_MAX;
...
(Name:'Потребление СО2';Frm:SSSS;Ed:'кг/1000м2';TipSens:TipIzm;Min:0;Max:1000;Def:HIDE_MIN_MAX;
    Index:0;Mech:DZM511_SENS_CO_1;Tag:calcConsumCO2;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
//64             DZ511_iMaxWater
//(Name:'Прогноз задания температуры';Frm:SSpS0;Ed:'°C';TipSens:TipCalc;Min:3;Max:35;Def:HIDE_MIN_MAX;
...
(Name:'Текущая система по стратегии';Frm:SSSS;Ed:'';TipSens:TipCalc;Min:0;Max:100;Def:HIDE_MIN_MAX;
    Index:DZ511_itKontur+DZ511_size1Kontur*7+2;Mech:DZM511_FRAM_SOUTH;AccessR:RW_INVISIBLE;AccessW:RW_INVISIBLE),     // скрыть
...
(Name:'Текущая система по стратегии';Frm:SSSpS;Ed:'';TipSens:TipIzm;Min:0;Max:10000;Def:HIDE_MIN_MAX;            // скрыть
    Index:DZ511_iZoneStatus+18;Mech:DZM511_VALVE1;AccessR:RW_INVISIBLE;AccessW:RW_INVISIBLE),
...
// 142
(Name:'Досветка 50%';Frm:SSSpS;Ed:'';TipSens:TipIzm;Min:-100;Max:100;Def:HIDE_MIN_MAX;
    //Index:DZ511_iZoneStatus+14;Mech:DZM511_LIGHT;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
    Index:DZ511_iZoneStatus+14;Mech:DZM511_LIGHT;Tag:calcLight50;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),

(Name:'Досветка 100%';Frm:SSSpS;Ed:'';TipSens:TipIzm;Min:-100;Max:100;Def:HIDE_MIN_MAX;
    //Index:DZ511_iZoneStatus+16;Mech:DZM511_LIGHT;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
    Index:DZ511_iZoneStatus+16;Mech:DZM511_LIGHT;Tag:calcLight100;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR),
