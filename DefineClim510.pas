...
const        DZ511_SumParTune=          136;//134
             DZ511_iSunToClim=          0;
...
//         (Name:'Клапан UC - минимальный шаг далее до максимума';Frm:SS;Ed:'%';TipSens:TipCalc;Min:1;Max:10;Def:6;Index:DZ511_iParFram+4;Mech:DZM511_FRAM_NORTH;AccessR:RW_SUPERVISOR;AccessW:RW_SUPERVISOR),
          ...
          // new
         (Name:'Фрамуги - Минимальный ветер при расчете';Frm:SS;Ed:'м/с';TipSens:TipCalc;Min:1;Max:5;Def:1;Index:DZ_iFram+12;Mech:DZM511_FRAM_NORTH;AccessR:RW_USERI;AccessW:RW_USER),
...
//         (Name:'Экран - Твнеш увеличивает открытие в';Frm:SSpSSS;Ed:'раз';TipSens:TipCalc;Min:0;Max:10;Def:5;Index:DZ511_iScreen+24;Mech:DZM511_SCREEN_TG;AccessR:RW_USERI;AccessW:RW_USER),
         ...
         (Name:'Увлажнение панели. Т выхода AHU - Т рукава ДЕРЖАТЬ = 100%';Frm:SS;Ed:'°C';TipSens:TipCalc;Min:0;Max:100;Def:0;Index:DZ511_EndTune-6;Mech:DZM511_FRAM_NORTH;AccessR:RW_GUEST;AccessW:RW_SUPERVISOR)
         );
//===============================================================================
